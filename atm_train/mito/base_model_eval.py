...
if __name__ == "__main__":
    ...
    evaluation_results = evaluator.evaluate_dataset(eval_data, output_file="evaluation_results_base.json")
    
    print("\nEvaluation complete. Results saved to evaluation_results_base.json")
