...
if __name__ == "__main__":
    ...
    evaluation_results = evaluator.evaluate_dataset(eval_data, output_file="mitodpofull_eval_chunks.json")
    
    print("\nEvaluation complete. Results saved to mitodpofull_eval_chunks.json")
