...
if __name__ == "__main__":
    ...
    evaluation_results = evaluator.evaluate_dataset(eval_data, output_file="mitoevaluation_results_noadapter.json")
    
    print("\nEvaluation complete. Results saved to mitoevaluation_results_noadapter.json")
