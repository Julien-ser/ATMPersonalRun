...
if __name__ == "__main__":
    # Example usage
    model_path = "/home/julien/ATM-RAG/atm_train/generator_sft/experiments/model_final"
    ...
    evaluation_results = evaluator.evaluate_dataset(eval_data, output_file="evaluation_results_gensft_chunks.json")
    
    print("\nEvaluation complete. Results saved to evaluation_results_gensft_chunks.json")
